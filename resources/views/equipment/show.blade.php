...
<div class="container mx-auto p-6">
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="mt-6 flex justify-end">
            <a href="{{ route('equipments.edit', $equipment->id) }}" class="bg-yellow-600 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-700">Edit Equipment</a>
            <form action="{{ route('equipment.destroy', $equipment->id) }}" method="POST" class="inline ml-4">
                @csrf
                @method('DELETE')
