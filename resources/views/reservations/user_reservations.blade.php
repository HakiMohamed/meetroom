...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-semibold mb-6 text-white dark:text-white">My Reservations</h1>
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                @foreach($reservations as $reservation)
                    <tr>
                        ...
                        <td class="inline-flex items-center px-3 py-1 text-sm font-medium rounded-full {{ $reservation->status === 'encours' ? 'bg-gray-300 text-blue-800' : 'bg-green-300 text-green-800' }}">{{ $reservation->status }}</td>
